...
@Component({
  ...
  template: `
    ...
    <form [formGroup]="form" (ngSubmit)="save()" class="col" mat-dialog-content>
...
export class UserAddDialog {
  ...
  constructor(
    ...
    private ref: MatDialogRef<UserAddDialog, AddUserResult>,
  ...
  save() { if (!this.form.invalid) this.ref.close(this.form.getRawValue() as AddUserResult); }
}
